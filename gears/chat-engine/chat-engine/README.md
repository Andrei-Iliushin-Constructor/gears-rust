...
| Route | What |
|---|---|
| `GET {prefix}/chat-engine/docs` | Interactive reference page (Stoplight Elements) |
| `GET {prefix}/chat-engine/openapi.json` | OpenAPI 3.1 document, 23 operations |
